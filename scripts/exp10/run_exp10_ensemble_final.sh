...
for SEED in "${SEEDS[@]}"; do
    ...
    "${PYTHON_BIN}" src/test_custom.py --model "$WEIGHTS" \
...
"${PYTHON_BIN}" src/ensemble_wbf.py --iou 0.6 \
...
"${PYTHON_BIN}" src/eval_csv_map.py --pred_csv submission/exp10_val/exp10_final_val_ensembled.csv \
